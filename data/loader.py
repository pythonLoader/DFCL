...
class DataLoader:
    ...
    def load_tasks(self, cid):
        if self.args.task in ['non_iid_50']:
            task_set = {
                0: ['cifar100_5', 'cifar100_13', 'traffic_sign_7', 'cifar100_14', 'svhn_1', 'traffic_sign_0', 'traffic_sign_6', 'cifar100_8', 'traffic_sign_3', 'cifar100_4'],
                1: ['cifar100_2', 'traffic_sign_5', 'cifar100_9', 'traffic_sign_4', 'cifar100_12', 'mnist_0', 'cifar100_11', 'traffic_sign_2', 'cifar100_1', 'fashion_mnist_1'],
                2: ['fashion_mnist_0', 'svhn_0', 'cifar100_15', 'cifar100_7', 'cifar100_0', 'cifar100_3', 'cifar100_10', 'mnist_1', 'cifar100_6', 'traffic_sign_1']
            }
            
            # task_set = {
            #     0: ['cifar100_5', 'cifar100_13', 'cifar10_0', 'cifar100_14', 'svhn_1', 'traffic_sign_0', 'not_mnist_1', 'cifar100_8', 'face_scrub_13', 'cifar100_4'],
            # }
            # task_set = {
